...
# Calcular el monto total gastado a lo largo del tiempo por atención de “Puppy”. Si el gasto efectuado
# es menor a 30000, mostrar en pantalla dicho resultado, caso contrario mostrar el mensaje “Gastos por
# encima de lo presupuestado”.

Historial = (2350, 5960, 23000, 1000, 8900)
total = 0
for i in range(len(Historial)):
    total = total + Historial[i]
if total < 30000:
